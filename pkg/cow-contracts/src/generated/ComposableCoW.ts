...
export interface ComposableCoWInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [IConditionalOrder.ConditionalOrderParamsStruct, string, BytesLike, boolean]
  ): string
  encodeFunctionData(functionFragment: 'domainSeparator', values?: undefined): string
  encodeFunctionData(
    functionFragment: 'getTradeableOrderWithSignature',
    values: [string, IConditionalOrder.ConditionalOrderParamsStruct, BytesLike, BytesLike[]]
  ): string
  ...
  encodeFunctionData(
    ...
    values: [string, string, BytesLike, BytesLike, BytesLike, BytesLike, BytesLike]
  ): string
...
export interface ConditionalOrderCreatedEventObject extends BaseEventObject {
  owner: string
  params: IConditionalOrder.ConditionalOrderParamsStructOutput
}
export type ConditionalOrderCreatedEvent = TypedEvent<ConditionalOrderCreatedEventObject>

export type ConditionalOrderCreatedEventFilter = TypedEventFilter<ConditionalOrderCreatedEventObject>

export interface MerkleRootSetEventObject extends BaseEventObject {
  owner: string
  root: string
  proof: ComposableCoW.ProofStructOutput
}
export type MerkleRootSetEvent = TypedEvent<MerkleRootSetEventObject>

export type MerkleRootSetEventFilter = TypedEventFilter<MerkleRootSetEventObject>

export interface SwapGuardSetEventObject extends BaseEventObject {
  owner: string
  swapGuard: string
}
export type SwapGuardSetEvent = TypedEvent<SwapGuardSetEventObject>

export type SwapGuardSetEventFilter = TypedEventFilter<SwapGuardSetEventObject>
...
export interface ComposableCoW extends BaseContract {
  ...
  functions: {
    ...
    remove(singleOrderHash: BytesLike, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    setSwapGuard(swapGuard: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  estimateGas: {
    ...
    remove(singleOrderHash: BytesLike, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    setSwapGuard(swapGuard: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    remove(singleOrderHash: BytesLike, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    setSwapGuard(swapGuard: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
