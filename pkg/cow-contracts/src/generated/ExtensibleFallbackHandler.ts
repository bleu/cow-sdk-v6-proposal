...
export interface AddedDomainVerifierEventObject extends BaseEventObject {
  safe: string
  domainSeparator: string
  verifier: string
}
export type AddedDomainVerifierEvent = TypedEvent<AddedDomainVerifierEventObject>

export type AddedDomainVerifierEventFilter = TypedEventFilter<AddedDomainVerifierEventObject>

export interface AddedInterfaceEventObject extends BaseEventObject {
  safe: string
  interfaceId: string
}
export type AddedInterfaceEvent = TypedEvent<AddedInterfaceEventObject>

export type AddedInterfaceEventFilter = TypedEventFilter<AddedInterfaceEventObject>

export interface AddedSafeMethodEventObject extends BaseEventObject {
  safe: string
  selector: string
  method: string
}
export type AddedSafeMethodEvent = TypedEvent<AddedSafeMethodEventObject>

export type AddedSafeMethodEventFilter = TypedEventFilter<AddedSafeMethodEventObject>

export interface ChangedDomainVerifierEventObject extends BaseEventObject {
  safe: string
  domainSeparator: string
  oldVerifier: string
  newVerifier: string
}
export type ChangedDomainVerifierEvent = TypedEvent<ChangedDomainVerifierEventObject>

export type ChangedDomainVerifierEventFilter = TypedEventFilter<ChangedDomainVerifierEventObject>

export interface ChangedSafeMethodEventObject extends BaseEventObject {
  safe: string
  selector: string
  oldMethod: string
  newMethod: string
}
export type ChangedSafeMethodEvent = TypedEvent<ChangedSafeMethodEventObject>

export type ChangedSafeMethodEventFilter = TypedEventFilter<ChangedSafeMethodEventObject>

export interface RemovedDomainVerifierEventObject extends BaseEventObject {
  safe: string
  domainSeparator: string
}
export type RemovedDomainVerifierEvent = TypedEvent<RemovedDomainVerifierEventObject>

export type RemovedDomainVerifierEventFilter = TypedEventFilter<RemovedDomainVerifierEventObject>

export interface RemovedInterfaceEventObject extends BaseEventObject {
  safe: string
  interfaceId: string
}
export type RemovedInterfaceEvent = TypedEvent<RemovedInterfaceEventObject>

export type RemovedInterfaceEventFilter = TypedEventFilter<RemovedInterfaceEventObject>

export interface RemovedSafeMethodEventObject extends BaseEventObject {
  safe: string
  selector: string
}
export type RemovedSafeMethodEvent = TypedEvent<RemovedSafeMethodEventObject>

export type RemovedSafeMethodEventFilter = TypedEventFilter<RemovedSafeMethodEventObject>
...
export interface ExtensibleFallbackHandler extends BaseContract {
  ...
  queryFilter<TEvent extends TypedEvent<Result>>(
    event: TypedEventFilter<TEvent['args']>,
    fromBlockOrBlockhash?: string | number | undefined,
    toBlock?: string | number | undefined
  ): Promise<Array<TEvent>>

  listeners<TEvent extends TypedEvent<Result>>(
    eventFilter?: TypedEventFilter<TEvent['args']>
  ): Array<TypedListener<TEvent['args']>>
  
  listeners(eventName?: string): Array<Listener>
  
  removeAllListeners<TEvent extends TypedEvent<Result>>(
    eventFilter: TypedEventFilter<TEvent['args']>
  ): this
  
  removeAllListeners(eventName?: string): this
  
  off<TEvent extends TypedEvent<Result>>(
    eventFilter: TypedEventFilter<TEvent['args']>,
    listener: TypedListener<TEvent['args']>
  ): this
  
  on<TEvent extends TypedEvent<Result>>(
    eventFilter: TypedEventFilter<TEvent['args']>,
    listener: TypedListener<TEvent['args']>
  ): this
  
  once<TEvent extends TypedEvent<Result>>(
    eventFilter: TypedEventFilter<TEvent['args']>,
    listener: TypedListener<TEvent['args']>
  ): this
  
  removeListener<TEvent extends TypedEvent<Result>>(
    eventFilter: TypedEventFilter<TEvent['args']>,
    listener: TypedListener<TEvent['args']>
  ): this
