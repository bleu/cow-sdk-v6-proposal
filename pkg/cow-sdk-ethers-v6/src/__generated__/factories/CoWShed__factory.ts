...
export class CoWShed__factory {
  ...
  static createInterface(): CoWShedInterface {
    return new Interface(_abi) as CoWShedInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): CoWShed {
    return new Contract(address, _abi, runner) as unknown as CoWShed;
  }
}
