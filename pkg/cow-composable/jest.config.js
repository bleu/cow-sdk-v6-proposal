...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@cowprotocol/cow-ts$': '<rootDir>/../../pkg/cow-ts/src/index.ts',
    '^@cowprotocol/cow-ts/(.*)$': '<rootDir>/../../pkg/cow-ts/src/$1',
    '^@cowprotocol/order-book$': '<rootDir>/../../pkg/cow-order-book/src/index.ts',
    '^@cowprotocol/order-book/(.*)$': '<rootDir>/../../pkg/cow-order-book/src/$1',
    '^@cowprotocol/signing$': '<rootDir>/../../pkg/cow-signing/src/index.ts',
    '^@cowprotocol/signing/(.*)$': '<rootDir>/../../pkg/cow-signing/src/$1',
