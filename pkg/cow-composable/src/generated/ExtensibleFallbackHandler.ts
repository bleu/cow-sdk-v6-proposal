...
export type AddedDomainVerifierEvent = TypedEvent<[string, string, string], AddedDomainVerifierEventObject>
...
export type AddedInterfaceEvent = TypedEvent<[string, string], AddedInterfaceEventObject>
...
export type ChangedDomainVerifierEvent = TypedEvent<[string, string, string, string], ChangedDomainVerifierEventObject>
...
export type RemovedDomainVerifierEvent = TypedEvent<[string, string], RemovedDomainVerifierEventObject>
...
export type RemovedInterfaceEvent = TypedEvent<[string, string], RemovedInterfaceEventObject>
